...
function addThemeBtn(){
    ...
    function changeTheme(){
        ...
        if(document.getElementsByClassName("readerControls_item white").length != 0){
            //设置白色主题
            Flag=-1
            browser.runtime.sendMessage({injectCss: "/theme/white.css"})
            ...
            browser.runtime.sendMessage({injectCss: "/theme/green.css"})
        }else if(Flag == 1){
            //设置橙色主题
            if(document.getElementsByClassName("readerControls_item white").length != 0){
                clickDarkOrWhite("readerControls_item white")
            }
            browser.runtime.sendMessage({injectCss: "/theme/orange.css"})
        }else if(Flag == 2){
            //设置黑色主题
            try {
